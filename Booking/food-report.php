...
{
$adminid=$_GET['id'];
$msg=mysqli_query($con,"delete from food where id='$adminid'");
if($msg)
{
  ...
  <body>
    ...
    <section id="container" >
        <header class="header black-bg"  style="background-color:black;">
            ...
            <a href="dashboard.php" class="logo"><b>Food Records </b></a>
        ...
        <section id="main-content">
            <section class="wrapper">
          	    <h3><i class="fa fa-angle-right"></i> Food Report</h3>
				<div class="row">  
                    <div class="col-md-12">
                        <div class="content-panel">
                            ...
                            <tbody>
                                <?php $ret=mysqli_query($con,"select * from food");
							        $cnt=1;
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="update-food.php?uid=<?php echo $row['id'];?>"> 
