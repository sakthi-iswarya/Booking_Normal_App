...
$sql=mysqli_query($con,"SELECT a_pass FROM admin where a_pass='$oldpassword'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
$adminid=$_SESSION['id'];
$newpass=md5($_POST['newpass']);
 $ret=mysqli_query($con,"update admin set a_pass='$newpass' where id='$adminid'");
...
<html lang="en">
  ...
  <header class="header black-bg"  style="background-color:black;">
            ...
            <a href="dashboard.php" class="logo"><b>Change Password </b></a>
				...
				<div class="row">			
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <input type="submit" name="Submit" value="Change" class="btn btn-theme" style="background-color:black; color:white;"></div>
                          </form>
                      </div>
                  </div>
              </div>
