...
if(isset($_POST['Submit']))
{
  ...
  $uid=intval($_GET['uid']);
$query=mysqli_query($con,"update movies set name='$name',email='$email',
movie_name='$movie_name', members_count='$members_count', date='$date' where id='$uid'");
...
<html lang="en">
  ...
  <body>
    ...
    <section id="container" >
      ...
      <?php $ret=mysqli_query($con,"select * from movies where id='".$_GET['uid']."'");
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="movie_name" value="<?php echo $row['movie_name'];?>" >
                              </div>
                          </div>
                              ...
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Email </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="members_count" value="<?php echo $row['members_count'];?>" readonly >
                              </div>
                          </div>
                               <div class="form-group">
