...
{
$adminid=$_GET['id'];
$msg=mysqli_query($con,"delete from dress where id='$adminid'");
if($msg)
{
  ...
  <body>
    ...
    <section id="container" >
        <header class="header black-bg"  style="background-color:black;">
            ...
            <a href="dashboard.php" class="logo"><b>Dress Records </b></a>
        ...
        <section id="main-content">
            <section class="wrapper">
          	    <h3><i class="fa fa-angle-right"></i> Dress Report</h3>
				<div class="row">  
                    <div class="col-md-12">
                        <div class="content-panel">
                            ...
                            <tbody>
                                <?php $ret=mysqli_query($con,"select * from dress");
							        $cnt=1;
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="update-dress.php?uid=<?php echo $row['id'];?>"> 
                                    <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                                    <a href="delete-dress.php?id=<?php echo $row['id'];?>"> 
