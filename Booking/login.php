...
if(isset($_POST['login']))
{
  ...
  $pass=$_POST['password'];
$ret=mysqli_query($con,"SELECT * FROM admin WHERE a_name='$adminusername' and a_pass='$pass'");
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" action="" method="post">
		        <h2 class="form-login-heading" style="background-color:white; color:black">Login</h2>
